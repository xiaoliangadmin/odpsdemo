...
public class UpdateDataSource {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //根据数据源id和数据库连接信息，在dataworks中更新数据源
            UpdateDataSourceRequest request3 = new UpdateDataSourceRequest();
            request3.setDataSourceId(sourceId);//数据源id
            request3.setEnvType(1);
            request3.setContent("{\"jdbcUrl\":\"jdbc:oracle:thin:@//100.100.105.171:1521/PROD\",\"username\":\"apps\",\"password\":\"apps\",\"tag\":\"public\"}");
            UpdateDataSourceResponse response3 = client.getAcsResponse(request3);
            System.out.println("oracle_test数据源是否更新成功：" + response3.getSuccess());
